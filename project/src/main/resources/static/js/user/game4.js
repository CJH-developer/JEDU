var modals4 = document.getElementById("myModal5");
var btn4 = document.querySelectorAll(".myBtns3");
var spans4 = document.getElementsByClassName("closes")[0];
// When the user clicks the button, open the modal
for (var i = 0; i < btn4.length; i++) {
  btn4[i].addEventListener("click", function() {
    modals4.style.display = "block";
