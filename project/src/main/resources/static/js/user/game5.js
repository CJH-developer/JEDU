var modals5 = document.getElementById("myModal6");
var btn5 = document.querySelectorAll(".myBtns4");
var spans5 = document.getElementsByClassName("closes")[0];
for (var i = 0; i < btn5.length; i++) {
  btn5[i].addEventListener("click", function() {
    modals5.style.display = "block";
